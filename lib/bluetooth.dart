...
enum BluetoothOptions { searching, connecting, connected, receivedServices, disconnected, dataReceived, stopSearching }
...
class Bluetooth {
  ...
  final List<BluetoothCallback> _callbacks = [];
  ...
  void _btScan() async {
    if (subscription == null) {
      ...
      FlutterBluePlus.startScan(timeout: d, androidUsesFineLocation: true, withNames: names ?? [], withServices: guid);
  ...
  Future<List<int>> read() async {
    ...
    for (var char in characteristic!) {
